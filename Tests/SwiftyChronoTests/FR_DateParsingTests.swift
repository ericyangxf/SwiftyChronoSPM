...
struct FR_DateParsingTests {
    ...
    func test102_LastYear() async throws {
        let chrono = Chrono(preferredLanguage: .french)
        let refDate = createRefDate(year: 2026, month: 1, day: 20)
        let result = chrono.parse(text: "Montre mon historique de dépenses l'année dernière", refDate: refDate)
        let startDate = try #require(result.first?.start.date)
        let startComponents = dateComponents(date: startDate)
        #expect(startComponents.year == 2025)
        #expect(startComponents.month == 1)
    ...
    func test105_LastMonth() async throws {
        let chrono = Chrono(preferredLanguage: .french)
        let refDate = createRefDate(year: 2026, month: 1, day: 20)
        let result = chrono.parse(text: "Montre mon historique de dépenses le mois dernier", refDate: refDate)
        let startDate = try #require(result.first?.start.date)
        let startComponents = dateComponents(date: startDate)
        #expect(startComponents.year == 2025)
        #expect(startComponents.month == 12)
    ...
    func test108_LastWeek() async throws {
        let chrono = Chrono(preferredLanguage: .french)
        let refDate = createRefDate(year: 2026, month: 1, day: 20)
        let result = chrono.parse(text: "Montre mon historique de dépenses la semaine dernière", refDate: refDate)
        let startDate = try #require(result.first?.start.date)
        let startComponents = dateComponents(date: startDate)
        #expect(startComponents.year == 2026)
        #expect(startComponents.month == 1)
    ...
    func test110_SinceMarch() async throws {
        ...
        let result = chrono.parse(text: "Montre mon historique de dépenses depuis mars", refDate: refDate)
        let startDate = try #require(result.first?.start.date)
        let startComponents = dateComponents(date: startDate)
        #expect(startComponents.year == 2026)
    ...
    func test111_SinceMarch20() async throws {
        let chrono = Chrono(preferredLanguage: .french)
        let refDate = createRefDate(year: 2026, month: 9, day: 1)
        let result = chrono.parse(text: "Montre mon historique de dépenses depuis le 20 mars", refDate: refDate)
        let startDate = try #require(result.first?.start.date)
        let startComponents = dateComponents(date: startDate)
        #expect(startComponents.year == 2026)
        #expect(startComponents.month == 3)
    ...
    func test112_SinceMarch20ToYesterday() async throws {
        let chrono = Chrono(preferredLanguage: .french)
        let refDate = createRefDate(year: 2026, month: 9, day: 1)
        let result = chrono.parse(text: "Montre mon historique de dépenses depuis le 20 mars jusqu'à hier", refDate: refDate)
        let startDate = try #require(result.first?.start.date)
        let startComponents = dateComponents(date: startDate)
        #expect(startComponents.year == 2026)
        #expect(startComponents.month == 3)
    ...
    func test113_FromMarch() async throws {
        let chrono = Chrono(preferredLanguage: .french)
        let refDate = createRefDate(year: 2026, month: 9, day: 1)
        let result = chrono.parse(text: "Montre mon historique de dépenses à partir de mars", refDate: refDate)
        let startDate = try #require(result.first?.start.date)
        let startComponents = dateComponents(date: startDate)
        #expect(startComponents.year == 2026)
        #expect(startComponents.month == 3)
    ...
    func test114_FromMarch20() async throws {
        let chrono = Chrono(preferredLanguage: .french)
        let refDate = createRefDate(year: 2026, month: 9, day: 1)
        let result = chrono.parse(text: "Montre mon historique de dépenses à partir du 20 mars", refDate: refDate)
        let startDate = try #require(result.first?.start.date)
        let startComponents = dateComponents(date: startDate)
        #expect(startComponents.year == 2026)
        #expect(startComponents.month == 3)
    ...
    func test115_FromMarch20ToYesterday() async throws {
        let chrono = Chrono(preferredLanguage: .french)
        let refDate = createRefDate(year: 2026, month: 9, day: 1)
        let result = chrono.parse(text: "Montre mon historique de dépenses à partir du 20 mars jusqu'à hier", refDate: refDate)
        let startDate = try #require(result.first?.start.date)
        let startComponents = dateComponents(date: startDate)
        #expect(startComponents.year == 2026)
        #expect(startComponents.month == 3)
